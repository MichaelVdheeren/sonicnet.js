...
var sonicSocket = void 0;
var sonicServer = void 0;
...
function createSonicNetwork(opt_coder) {
  ...
  if (opt_coder) {
    sonicServer = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["b" /* SonicServer */]({ coder: opt_coder });
    sonicSocket = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["c" /* SonicSocket */]({ coder: opt_coder });
  } else {
    sonicServer = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["b" /* SonicServer */]({ alphabet: ALPHABET, debug: false });
    sonicSocket = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["c" /* SonicSocket */]({ alphabet: ALPHABET });
  }
...
isAudibleEl.addEventListener('click', function (e) {
  if (e.target.checked) {
    var coder = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["a" /* SonicCoder */]({
      freqMin: 440,
      freqMax: 1760
    });
...
module.exports = __webpack_require__("./emoticons/index.js");
