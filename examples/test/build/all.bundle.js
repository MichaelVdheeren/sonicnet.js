...
function onButton() {
  var ssocket = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["c" /* SonicSocket */]({ alphabet: ALPHABET, charDuration: 0.2 });
  ssocket.send(MESSAGE);
}

// On some other machine:
var sserver = new __WEBPACK_IMPORTED_MODULE_0__lib_src_index__["b" /* SonicServer */]({ alphabet: ALPHABET });
...
module.exports = __webpack_require__("./test/index.js");
